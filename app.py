...
# --- Utility Imports ---
from utility.colorName import get_color_name
from utility.colorName import recommend_outfit
from utility.image_fetch import fetch_outfit_images
# from utility.input import process_user_input
# from utility.url_search import generate_pinterest_query
...
def generate_url():
    ...
    query = generate_pinterest_query(occasion, weather, colors)
